...
def check_database():
    ...
    temp_cursor.execute("CREATE DATABASE IF NOT EXISTS movie_munchers")
    temp_cursor.close()
    root.close()
...
cursor_object.execute("SET FOREIGN_KEY_CHECKS = 0")
cursor_object.execute("DROP TABLE IF EXISTS theatres")
cursor_object.execute("DROP TABLE IF EXISTS auditoriums")
cursor_object.execute("DROP TABLE IF EXISTS seats")
cursor_object.execute("DROP TABLE IF EXISTS users")
cursor_object.execute("DROP TABLE IF EXISTS staff")
cursor_object.execute("DROP TABLE IF EXISTS movies")
cursor_object.execute("DROP TABLE IF EXISTS movie_showings")
cursor_object.execute("DROP TABLE IF EXISTS customers")
cursor_object.execute("DROP TABLE IF EXISTS customer_showings")
cursor_object.execute("DROP TABLE IF EXISTS payment_methods")
cursor_object.execute("DROP TABLE IF EXISTS drivers")
cursor_object.execute("DROP TABLE IF EXISTS suppliers")
cursor_object.execute("DROP TABLE IF EXISTS products")
cursor_object.execute("DROP TABLE IF EXISTS deliveries")
cursor_object.execute("DROP TABLE IF EXISTS delivery_items")
cursor_object.execute("SET FOREIGN_KEY_CHECKS = 1")
...
auditoriums = """CREATE TABLE auditoriums (
                id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
movie_showings = """CREATE TABLE movie_showings (
                   id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
customer_showings = """CREATE TABLE customer_showings (
                       id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
delivery_items = """CREATE TABLE delivery_items (
                id BIGINT AUTO_INCREMENT PRIMARY KEY,
